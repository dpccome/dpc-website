	...
	* */
	...
	_helpers.paginationNavigation = function (pages, currentPage, totalPages, options) {
		...
		_.each(pages, function (page, ctr) {
			...
			var aClass = ((isActivePage) ? 'class="u-pagination-v1__item u-pagination-v1-4 u-pagination-v1-4--active g-rounded-50 g-pa-7-14"' : 'class="u-pagination-v1__item u-pagination-v1-4 g-rounded-50 g-pa-7-14"');
			...
			// wrapup the html
			html += '<li class="list-inline-item"><a ' + aClass + ' href="' + pageUrl + '">' + pageText + '</a></li>\n';
		});
		return html;
	};
